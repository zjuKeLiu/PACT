...
root_path = "/home/liuke/liuke/prj/score/CrystalTransformer/dataset/G"
...
for epoch in range(200):
    ...
    if test_loss_F < best_MAE:  # 只要模型效果变好，就保存
        ...
        torch.save(CryT, '/home/liuke/liuke/prj/score/CrystalTransformer/multi_hierachy/test/G/best.pt')
